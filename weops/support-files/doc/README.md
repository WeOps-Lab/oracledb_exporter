...
| oracledb_asm_diskgroup_free                    | Oracle数据库ASM磁盘组可用空间   | name                                                                            | 磁盘组名称                                      | bytes   |
| oracledb_asm_diskgroup_total                   | Oracle数据库ASM磁盘组总容量    | name                                                                            | 磁盘组名称                                      | bytes   |
| oracledb_asm_diskgroup_usage                   | Oracle数据库ASM磁盘组空间使用率  | name                                                                            | 磁盘组名称                                      | percent |
